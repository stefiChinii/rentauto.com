...
import static extensions.DateExtensions.*
...
class Reserva {
	...
	/**
	 * Para Hibernate. No tocar!!
	 */
	 new(){
	 	
	 }
	
	  new(Ubicacion origen, Ubicacion destino, Date inicio, Date fin, Auto auto, IUsuario usuario) {
		super()
		this.origen=origen
	...
	def reservar(){
		auto.agregarReserva(this)
		usuario.agregarReserva(this)
	}
}
